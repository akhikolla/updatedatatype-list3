...
TEST(,){
  ...
  std::string x_t = "/home/akhila/fuzzer_packages/fuzzedpackages/myTAI/inst/testfiles/cpp_harmonic_mean/AFL_cpp_harmonic_mean/afl_inputs/" + std::to_string(t) + "_x.qs";
  qs::c_qsave(x,x_t,
