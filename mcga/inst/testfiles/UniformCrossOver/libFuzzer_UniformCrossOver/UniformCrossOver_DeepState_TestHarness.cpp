...
TEST(,){
  ...
  std::string bytes1_t = "/home/akhila/fuzzer_packages/fuzzedpackages/mcga/inst/testfiles/UniformCrossOver/libFuzzer_UniformCrossOver/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_bytes1.qs";
  qs::c_qsave(bytes1,bytes1_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "bytes1 values: "<< bytes1 << std::endl;
  IntegerVector bytes2  = RcppDeepState_IntegerVector();
  std::string bytes2_t = "/home/akhila/fuzzer_packages/fuzzedpackages/mcga/inst/testfiles/UniformCrossOver/libFuzzer_UniformCrossOver/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_bytes2.qs";
