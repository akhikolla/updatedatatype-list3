...
TEST(,){
  ...
  std::string mu_t = "/home/akhila/fuzzer_packages/fuzzedpackages/metafolio/inst/testfiles/impl_error/AFL_impl_error/afl_inputs/" + std::to_string(t) + "_mu.qs";
  qs::c_qsave(mu,mu_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "mu values: "<< mu << std::endl;
  NumericVector sigma_impl(1);
  sigma_impl[0]  = RcppDeepState_double();
  std::string sigma_impl_t = "/home/akhila/fuzzer_packages/fuzzedpackages/metafolio/inst/testfiles/impl_error/AFL_impl_error/afl_inputs/" + std::to_string(t) + "_sigma_impl.qs";
