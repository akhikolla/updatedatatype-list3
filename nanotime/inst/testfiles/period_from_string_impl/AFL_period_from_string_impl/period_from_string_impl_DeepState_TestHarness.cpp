...
TEST(,){
  ...
  std::string str_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nanotime/inst/testfiles/period_from_string_impl/AFL_period_from_string_impl/afl_inputs/" + std::to_string(t) + "_str.qs";
