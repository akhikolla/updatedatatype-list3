...
TEST(,){
  ...
  std::string v_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nanotime/inst/testfiles/nanotime_subset_numeric_impl/AFL_nanotime_subset_numeric_impl/afl_inputs/" + std::to_string(t) + "_v.qs";
  qs::c_qsave(v,v_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "v values: "<< v << std::endl;
  NumericVector idx  = RcppDeepState_NumericVector();
  std::string idx_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nanotime/inst/testfiles/nanotime_subset_numeric_impl/AFL_nanotime_subset_numeric_impl/afl_inputs/" + std::to_string(t) + "_idx.qs";
