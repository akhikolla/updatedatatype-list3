...
TEST(,){
  ...
  qs::c_qsave(v,"/home/akhila/fuzzer_packages/fuzzedpackages/nanotime/inst/testfiles/nanoduration_subset_numeric_impl/inputs/v.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "v values: "<< v << std::endl;
  NumericVector idx  = RcppDeepState_NumericVector();
  qs::c_qsave(idx,"/home/akhila/fuzzer_packages/fuzzedpackages/nanotime/inst/testfiles/nanoduration_subset_numeric_impl/inputs/idx.qs",
		"high", "zstd", 1, 15, true, 1);
