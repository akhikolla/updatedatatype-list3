...
TEST(,){
  ...
  qs::c_qsave(a,"/home/akhila/fuzzer_packages/fuzzedpackages/metacoder/inst/testfiles/euclid/inputs/a.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "a values: "<< a << std::endl;
  NumericVector b  = RcppDeepState_NumericVector();
  qs::c_qsave(b,"/home/akhila/fuzzer_packages/fuzzedpackages/metacoder/inst/testfiles/euclid/inputs/b.qs",
		"high", "zstd", 1, 15, true, 1);
