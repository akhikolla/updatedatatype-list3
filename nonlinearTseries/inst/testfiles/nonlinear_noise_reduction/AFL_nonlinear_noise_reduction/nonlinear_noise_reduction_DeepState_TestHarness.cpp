...
TEST(,){
  ...
  std::string timeSeries_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/nonlinear_noise_reduction/AFL_nonlinear_noise_reduction/afl_inputs/" + std::to_string(t) + "_timeSeries.qs";
  ...
  std::string embeddingDimension_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/nonlinear_noise_reduction/AFL_nonlinear_noise_reduction/afl_inputs/" + std::to_string(t) + "_embeddingDimension.qs";
  ...
  std::string radius_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/nonlinear_noise_reduction/AFL_nonlinear_noise_reduction/afl_inputs/" + std::to_string(t) + "_radius.qs";
  qs::c_qsave(radius,radius_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "radius values: "<< radius << std::endl;
  IntegerVector nBoxes(1);
  nBoxes[0]  = RcppDeepState_int();
  std::string nBoxes_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/nonlinear_noise_reduction/AFL_nonlinear_noise_reduction/afl_inputs/" + std::to_string(t) + "_nBoxes.qs";
