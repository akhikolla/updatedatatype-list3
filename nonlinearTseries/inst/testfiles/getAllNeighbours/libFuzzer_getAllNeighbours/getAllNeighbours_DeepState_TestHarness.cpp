...
TEST(,){
  ...
  std::string phaseSpace_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/getAllNeighbours/libFuzzer_getAllNeighbours/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_phaseSpace.qs";
  ...
  std::string radius_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/getAllNeighbours/libFuzzer_getAllNeighbours/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_radius.qs";
  ...
  std::string numberBoxes_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/getAllNeighbours/libFuzzer_getAllNeighbours/libfuzzer_inputs/" + std::to_string(current_timestamp) +
          "_numberBoxes.qs";
