...
TEST(,){
  ...
  std::string timeSeries_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/lyapunov_exponent/AFL_lyapunov_exponent/afl_inputs/" + std::to_string(t) + "_timeSeries.qs";
  ...
  std::string minEmbeddingDim_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/lyapunov_exponent/AFL_lyapunov_exponent/afl_inputs/" + std::to_string(t) + "_minEmbeddingDim.qs";
  ...
  std::string maxEmbeddingDim_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/lyapunov_exponent/AFL_lyapunov_exponent/afl_inputs/" + std::to_string(t) + "_maxEmbeddingDim.qs";
  ...
  std::string timeLag_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/lyapunov_exponent/AFL_lyapunov_exponent/afl_inputs/" + std::to_string(t) + "_timeLag.qs";
  qs::c_qsave(timeLag,timeLag_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "timeLag values: "<< timeLag << std::endl;
  NumericVector radius(1);
  radius[0]  = RcppDeepState_double();
  std::string radius_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/lyapunov_exponent/AFL_lyapunov_exponent/afl_inputs/" + std::to_string(t) + "_radius.qs";
  ...
  std::string theilerWindow_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/lyapunov_exponent/AFL_lyapunov_exponent/afl_inputs/" + std::to_string(t) + "_theilerWindow.qs";
  ...
  std::string minNumNeighbours_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/lyapunov_exponent/AFL_lyapunov_exponent/afl_inputs/" + std::to_string(t) + "_minNumNeighbours.qs";
  ...
  std::string nRefPoints_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/lyapunov_exponent/AFL_lyapunov_exponent/afl_inputs/" + std::to_string(t) + "_nRefPoints.qs";
  ...
  std::string maxTimeSteps_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/lyapunov_exponent/AFL_lyapunov_exponent/afl_inputs/" + std::to_string(t) + "_maxTimeSteps.qs";
  ...
  std::string nBoxes_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/lyapunov_exponent/AFL_lyapunov_exponent/afl_inputs/" + std::to_string(t) + "_nBoxes.qs";
