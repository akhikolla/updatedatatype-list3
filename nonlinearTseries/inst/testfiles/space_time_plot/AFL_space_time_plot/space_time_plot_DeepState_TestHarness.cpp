...
TEST(,){
  ...
  std::string phaseSpace_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/space_time_plot/AFL_space_time_plot/afl_inputs/" + std::to_string(t) + "_phaseSpace.qs";
  ...
  std::string radii_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/space_time_plot/AFL_space_time_plot/afl_inputs/" + std::to_string(t) + "_radii.qs";
  qs::c_qsave(radii,radii_t,
		"high", "zstd", 1, 15, true, 1);
  std::cout << "radii values: "<< radii << std::endl;
  IntegerVector nTimeSteps(1);
  nTimeSteps[0]  = RcppDeepState_int();
  std::string nTimeSteps_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/space_time_plot/AFL_space_time_plot/afl_inputs/" + std::to_string(t) + "_nTimeSteps.qs";
  ...
  std::string timeStep_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/space_time_plot/AFL_space_time_plot/afl_inputs/" + std::to_string(t) + "_timeStep.qs";
  ...
  std::string nPercentages_t = "/home/akhila/fuzzer_packages/fuzzedpackages/nonlinearTseries/inst/testfiles/space_time_plot/AFL_space_time_plot/afl_inputs/" + std::to_string(t) + "_nPercentages.qs";
